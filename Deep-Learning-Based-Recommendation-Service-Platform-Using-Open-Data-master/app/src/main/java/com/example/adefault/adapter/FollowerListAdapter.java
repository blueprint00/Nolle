...
public class FollowerListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<FollowerList> followers;
    private Context context;

    public FollowerListAdapter(List<FollowerList> followlist,Context context){
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder,final int position) { //클릭 이벤트 처리
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("user_nickname",followers.get(position).getFollower_nickname());
    ...
    private void populateItemRows(ItemViewHolder viewHolder, int position) {
        ...
        String image = followers.get(position).getFollower_image();
        String nickname = followers.get(position).getFollower_nickname();
        String userName = followers.get(position).getFollower_name();
